...
{
    return GetBoolArg("-testnet", false) ? 42142 : 32142;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "ERPCOIN server stopping";
}
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use erpcoind";
